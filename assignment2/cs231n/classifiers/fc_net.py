...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        a_hidden, cache_hidden = affine_relu_forward(x_, self.params['W1'], self.params['b1'])
        scores, cache_score = affine_forward(a_hidden, self.params['W2'], self.params['b2'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        loss = data_loss + reg_loss(self.params['W1']) + reg_loss(self.params['W2'])
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i, hd in enumerate(hidden_dims):
            ...
            if self.use_batchnorm:
                self.bn_params[i]['gamma'] = np.ones(hd)
                self.bn_params[i]['beta'] = np.zeros(hd)
            layer_input_dim = hd
        ...
        # print(self.params['b1'].shape, self.params['b2'].shape, self.params['b3'].shape)
    ...
    def affine_batchnorm_relu_forward(self, x, w, b, bn_param):
        x_, fc_cache = affine_forward(x, w, b)
        a, batch_cache = batchnorm_forward(x_, bn_param['gamma'], bn_param['beta'], bn_param)
