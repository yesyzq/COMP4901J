...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        x, cache_embedding = word_embedding_forward(captions_in, W_embed)  # think
    ...
    def sample(self, features, max_length=30):
        ...
        # a loop.                                                                 #
        ###########################################################################
        captions[:, 0] = self._start  # the first word should be <start>
        ...
        for i in range(1, max_length):
            prev_word_embed  = W_embed[prev_word_idx]  # size: (N, D) where W_embed (V, D)
            ...
            output, _ = affine_forward(next_h, W_vocab, b_vocab)
            captions[:,i] = list(np.argmax(output, axis = 1))
